...
export const AuthService = {
    ...
    refreshToken: async (refreshToken) => {
        try {
            const decodedAccount = await verifyAsync(refreshToken, process.env.JWT_REFRESH_KEY);
            const data = { accountId: decodedAccount.accountId, is_admin: decodedAccount.is_admin };
            const accessToken = AuthService.generateAccessToken(data);
